...
def main():
    ...
    print("Running Phase 1: Task Breakdown...")
    crew1 = Crew(
    ...
    task_list_str = result1.raw

    # Pass Phase 1 output as approved requirements for Phase 2
    inputs['project_requirements'] = task_list_str

    # Phase 2: Estimation & Resource Allocation
    print("Running Phase 2: Estimation & Resource Allocation...")
    crew2 = Crew(
        agents=[estimation_agent, resource_allocation_agent],
        tasks=[time_resource_estimation, resource_allocation],
        verbose=True
    )
    result = crew2.kickoff(inputs=inputs)
